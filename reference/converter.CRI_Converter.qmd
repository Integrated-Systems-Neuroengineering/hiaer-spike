...
`converter.CRI_Converter(self, num_steps=4, input_layer=0, output_layer=11, input_shape=(1, 28, 28), backend='spikingjelly', v_threshold=1000000.0, embed_dim=4)`
...
|----------------|--------------|--------------------------------------------------------|------------------|
| `num_steps`    | int          | The number of time steps in the input. Default is 4.   | `4`              |
| `input_layer`  | int          | The index of the input layer. Default is 0.            | `0`              |
| `output_layer` | int          | The index of the output layer. Default is 11.          | `11`             |
| `input_shape`  | tuple of int | The shape of the input data. Default is (1, 28, 28).   | `(1, 28, 28)`    |
| `backend`      | str          | The backend to use. Default is 'spikingjelly'.         | `'spikingjelly'` |
| `v_threshold`  | float        | The voltage threshold for the neurons. Default is 1e6. | `1000000.0`      |
| `embed_dim`    | int          | The embedding dimension. Default is 4.                 | `4`              |
